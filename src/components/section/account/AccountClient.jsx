  ...
  return (
    <div className="flex flex-col gap-2">
      <button
        ...
        className={`flex items-center gap-3 px-4 py-3 rounded-xl font-medium transition-colors ${activeTab === "perfil" ? "bg-brand-300 text-black" : "hover:bg-slate-100 text-slate-700"
          }`}
      >
      ...
      <button
        ...
        className={`flex items-center gap-3 px-4 py-3 border rounded-xl font-medium transition-colors ${activeTab === "historial-reservas" ? "bg-brand-300 border-transparent text-black" : "bg-white border-slate-200 hover:bg-slate-50 text-slate-700"
          }`}
      >
      ...
      <button
        ...
        className={`flex items-center gap-3 px-4 py-3 border rounded-xl font-medium transition-colors ${activeTab === "historial-compras" ? "bg-brand-300 border-transparent text-black" : "bg-white border-slate-200 hover:bg-slate-50 text-slate-700"
          }`}
      >
      ...
      <button
        ...
        className={`flex items-center gap-3 px-4 py-3 border rounded-xl font-medium transition-colors ${activeTab === "preferencias" ? "bg-brand-300 border-transparent text-black" : "bg-white border-slate-200 hover:bg-slate-50 text-slate-700"
          }`}
      >
