  ...
  return (
    <div className="flex flex-col gap-2">
      <button
        ...
        className={`flex items-center gap-3 px-4 py-3 rounded-xl font-medium transition-colors ${activeTab === "perfil" ? "bg-[#1e2939] text-white" : "hover:bg-slate-100 text-slate-700"
          }`}
      >
